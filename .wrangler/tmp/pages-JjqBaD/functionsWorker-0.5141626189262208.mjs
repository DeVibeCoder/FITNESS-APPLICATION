...
var endpointFor = /* @__PURE__ */ __name((model) => `https://generativelanguage.googleapis.com/v1beta/models/${model}:generateContent`, "endpointFor");
...
// ../server/foodScan/mockVisionProvider.ts
...
var hostEnv = /* @__PURE__ */ __name(() => globalThis.process?.env ?? {}, "hostEnv");
...
async function runFoodScan(body, providers, signal, onRetry) {
  ...
  const { value: vision, attempts } = await withRetry(
    ({ timeoutMs }) => providers.vision.identify(image, signal, timeoutMs),
    {
      ...
      timeoutFor: /* @__PURE__ */ __name((index) => [2e4, 3e4, 4e4][index] ?? 3e4, "timeoutFor"),
      onRetry
    }
  );
...
var onRequest = /* @__PURE__ */ __name(async () => Response.json({ error: "method_not_allowed" }, { status: 405 }), "onRequest");

// ../.wrangler/tmp/pages-JjqBaD/functionsRoutes-0.09144800452332935.mjs
var routes = [
  {
...
// C:/Users/ultimanium/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/ultimanium/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-tJeCRU/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-tJeCRU/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5141626189262208.mjs.map
